...
function EmailValido(email) {
    if (((email.search(/[^@\-\.\w]|^[_@\.\-]|[\._\-]{2}|[@\.]{2}|(@)[^@]*\1/) !== -1) || (email.search(/@[\w\-]+\./)) === -1) || (email.search(/\.[a-zA-Z]{2,3}$/) === -1)) { return false; }
    else {
        return true;
    }
}
function ehumaDataValida(s) {
    var bits = s.split('/');
