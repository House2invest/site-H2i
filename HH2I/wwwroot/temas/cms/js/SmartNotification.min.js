    ...
    $.SmartMessageBox = function (settings, callback) {
        ...
        if (settings.sound === true) {
            if (isIE8orlower() === 0) {
                ...
                audioElement.setAttribute("src", "/temas/cms/sound/messagebox.mp3");
                $.get();
        ...
        if (settings.input !== undefined) {
            ...
            switch (settings.input) {
                case "text": InputType = "<input class='form-control' type='" + settings.input + "' id='txt" + SmartMSGboxCount + "' placeholder='" + settings.placeholder + "'/><br/><br/>";
                    break;
                case "password": InputType = "<input class='form-control' type='" + settings.input + "' id='txt" + SmartMSGboxCount + "' placeholder='" + settings.placeholder + "'/><br/><br/>";
                    break;
                case "select":
        ...
        Content = "<div class='MessageBoxContainer animated fadeIn fast " + settings.classe + "' id='Msg" + SmartMSGboxCount + "'>";
        ...
        if (settings.sound === true) {
            if (isIE8orlower() === 0) {
                ...
                if (navigator.userAgent.match("Firefox/")) {
                    audioElement.setAttribute("src", "/temas/cms/sound/bigbox.ogg");
                } else {
                    audioElement.setAttribute("src", "/temas/cms/sound/bigbox.mp3");
                } $.get();
    ...
    $.smallBox = function (settings, callback) {
        ...
        if (settings.sound === true) {
            if (isIE8orlower() === 0) {
                var audioElement = document.createElement("audio");
                if (navigator.userAgent.match("Firefox/")) {
                    audioElement.setAttribute("src", "/temas/cms/sound/smallbox.ogg");
                } else {
                    audioElement.setAttribute("src", "/temas/cms/smallbox.mp3");
                }
                $.get();
