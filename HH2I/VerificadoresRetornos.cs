...
namespace House2Invest
{
    ...
    public static class VerificadoresRetornos
    {
        ...
        //    buil = AsyncTaskMethodBuilder.Create();
        //    __state = -1;
        ...
        public static string EnviarEmail(ObjetoEmailEnvio modelo)
        {
            //d__.modelo = modelo;
        ...
        public static string EnviarImagemAzure(IFormFile Request, string AccountName, string AccountKey, string ContainerName, bool SimuladorLocal, string EnderecoLocalArmaz)
        {
        ...
        public static string EnviarImagemAzure(IFormFile Request, string AccountName, string AccountKey, string ContainerName, bool SimuladorLocal, string EnderecoLocalArmaz,string teste)
        {
            //(EnviarImagemAzure)d__34 d__;
            //d__.Request = Request;
            //d__.AccountName = AccountName;
        ...
        public static string EnviarImagemAzure(Image Request, int tamanhomaximobytes, string extensao, int LarguraMaxima, int AlturaMaxima, string AccountName, string AccountKey, string ContainerName)
        {
            ...
            return new string("Teste2");
        }

        //[AsyncStateMachine((Type)typeof((EnviarImagemAzure))]
        public static string EnviarImagemAzure(IFormFile Request, int tamanhomaximobytes, int LarguraMaxima, int AlturaMaxima, string AccountName, string AccountKey, string ContainerName, bool SimuladorLocal, string EnderecoLocalArmaz)
        {
        ...
        public static string GerarSenha(int minLength, int maxLength)
        {
        ...
        //{
        //    byte[] buffer = Encoding.ASCII.GetBytes("BM");
        //    byte[] buffer2 = Encoding.ASCII.GetBytes("GIF");
        ...
        public static int RetornaIdade(DateTime datanascimento)
        {
            ...
            try
            {
                num = DateTime.Now.Year - datanascimento.Year;
            }
            catch (Exception)
            {
            }
        ...
        public static string RetornaTamanhoArquivoParaHumanos(long value, int decimalPlaces)
        {
            ...
            decimal num2 = value / ((((index * 10) & 0x3f)));
        ...
        public static bool ValidaCPF(string cpf)
        {
            ...
            if (cpf != null)
            {
                uint num3 = (uint)cpf.GetHashCode();
                if (num3 <= 0x33851313)
                {
                    if (num3 <= 0x8cca6a1)
                    {
