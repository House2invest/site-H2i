(function ($) {
    ...
    $(document).ready(function () {
        ...
        //            + '<span class="timer-count">%-D <span class="timer-text">Dias</span></span>  '
        //            + '<span class="timer-count">%H <span class="timer-text">Horas</span></span> '
        //            + '<span class="timer-count">%M <span class="timer-text">Mins</span></span> '
        //            + '<span class="timer-count">%S <span class="timer-text">Segs</span></span>'));
        //    });
        //});
        ...
        //    $this.countdown(finalDate, function (event) {
        //        var $this = $(this).html(event.strftime(' '
        //            + '<div class="xs-timer-container"><span class="timer-count">%-D </span><span class="timer-text">Dias</span></div>'
        //            + '<div class="xs-timer-container"><span class="timer-count">%H </span><span class="timer-text">Horas</span></div>'
        //            + '<div class="xs-timer-container"><span class="timer-count">%M </span><span class="timer-text">Mins</span></div>'
        //            + '<div class="xs-timer-container"><span class="timer-count">%S </span><span class="timer-text">Segs</span></div>'));
        //    });
        //});
